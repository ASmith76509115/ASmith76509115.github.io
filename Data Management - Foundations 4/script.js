...
function submitQuiz() {
    ...
    const correctAnswers = {
        ...
        q5: { answer: "B", explanation: "Operators such as =, <>, >, <, >=, <=, AND, OR, BETWEEN, LIKE, and IN can be used in a WHERE clause." },
        ...
        q33: { answer: "B", explanation: "The % wildcard represents zero, one, or multiple characters." },
        q34: { answer: "B", explanation: "The _ wildcard represents exactly one character." },
        q35: { answer: "B", explanation: "An INNER JOIN returns only rows where there is a match in both tables." },
        q36: { answer: "B", explanation: "A LEFT JOIN returns all rows from the left table and matched rows from the right table." },
        q37: { answer: "B", explanation: "A RIGHT JOIN returns all rows from the right table and matched rows from the left table." },
        q38: { answer: "B", explanation: "A FULL OUTER JOIN returns all rows when there is a match in either table, filling in NULLs for unmatched rows." },
        q39: { answer: "B", explanation: "A CROSS JOIN returns the Cartesian product of two tables, combining all rows from both tables." },
        ...
        q41: { answer: "B", explanation: "Use COUNT(DISTINCT column_name) to count unique values in a column." },
        ...
        q46: { answer: "B", explanation: "A primary key ensures that a column or combination of columns uniquely identifies each row in a table." },
        q47: { answer: "B", explanation: "A foreign key establishes a link between columns in two tables, enforcing referential integrity." },
        ...
        q67: { answer: "B", explanation: "A primary key ensures each row is unique and does not allow NULLs, while a unique key allows NULL values." },
        q68: { answer: "B", explanation: "TRUNCATE TABLE removes all rows from a table, resetting any auto-increment counters, but retains the table structure." },
        q69: { answer: "B", explanation: "DROP removes the entire table structure, while DELETE removes specific rows from a table." },
        q70: { answer: "B", explanation: "A stored procedure is a set of SQL statements saved in the database that can be executed as a unit." },
        q71: { answer: "B", explanation: "A trigger is a set of SQL statements that automatically executes in response to specific database events." },
        q72: { answer: "B", explanation: "A cursor is a database object used to retrieve and manipulate rows in a result set one at a time." },
        q73: { answer: "B", explanation: "FETCH retrieves the next row from the cursor result set, enabling row-by-row processing." },
        q74: { answer: "B", explanation: "CHECK ensures that all values in a column meet a specified condition." },
        q75: { answer: "B", explanation: "A default constraint provides a default value for a column when no value is specified." },
        q76: { answer: "B", explanation: "NOW() returns the current date and time, useful for timestamping or comparing with other date values." }
    };
